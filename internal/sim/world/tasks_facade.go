...
func handleTaskMine(w *World, a *Agent, tr protocol.TaskReq, nowTick uint64) {
	workruntimepkg.HandleTaskMine(workTaskReqWorldEnv{w: w}, actionResult, a, tr, nowTick, w.cfg.AllowMine)
}

func handleTaskGather(w *World, a *Agent, tr protocol.TaskReq, nowTick uint64) {
	workruntimepkg.HandleTaskGather(workTaskReqWorldEnv{w: w}, actionResult, a, tr, nowTick)
}

func handleTaskPlace(w *World, a *Agent, tr protocol.TaskReq, nowTick uint64) {
	workruntimepkg.HandleTaskPlace(workTaskReqWorldEnv{w: w}, actionResult, a, tr, nowTick, w.cfg.AllowPlace)
}

func handleTaskOpen(w *World, a *Agent, tr protocol.TaskReq, nowTick uint64) {
	workruntimepkg.HandleTaskOpen(workTaskReqWorldEnv{w: w}, actionResult, a, tr, nowTick)
}

func handleTaskTransfer(w *World, a *Agent, tr protocol.TaskReq, nowTick uint64) {
	workruntimepkg.HandleTaskTransfer(workTaskReqWorldEnv{w: w}, actionResult, a, tr, nowTick)
}

func handleTaskCraft(w *World, a *Agent, tr protocol.TaskReq, nowTick uint64) {
	workruntimepkg.HandleTaskCraft(workTaskReqWorldEnv{w: w}, actionResult, a, tr, nowTick)
}

func handleTaskSmelt(w *World, a *Agent, tr protocol.TaskReq, nowTick uint64) {
	workruntimepkg.HandleTaskSmelt(workTaskReqWorldEnv{w: w}, actionResult, a, tr, nowTick)
}
...
func (w *World) tickMine(a *Agent, wt *tasks.WorkTask, nowTick uint64) {
	workruntimepkg.TickMine(workTaskExecWorldEnv{w: w}, a, wt, nowTick)
}

func (w *World) tickGather(a *Agent, wt *tasks.WorkTask, nowTick uint64) {
	workruntimepkg.TickGather(workTaskExecWorldEnv{w: w}, a, wt, nowTick)
}

func (w *World) tickPlace(a *Agent, wt *tasks.WorkTask, nowTick uint64) {
	workruntimepkg.TickPlace(workTaskExecWorldEnv{w: w}, a, wt, nowTick)
}

func (w *World) tickOpen(a *Agent, wt *tasks.WorkTask, nowTick uint64) {
	workruntimepkg.TickOpen(workTaskExecWorldEnv{w: w}, a, wt, nowTick)
}

func (w *World) tickTransfer(a *Agent, wt *tasks.WorkTask, nowTick uint64) {
	workruntimepkg.TickTransfer(workTaskExecWorldEnv{w: w}, a, wt, nowTick)
}

func (w *World) tickCraft(a *Agent, wt *tasks.WorkTask, nowTick uint64) {
	workruntimepkg.TickCraft(workTaskExecWorldEnv{w: w}, a, wt, nowTick)
}

func (w *World) tickSmelt(a *Agent, wt *tasks.WorkTask, nowTick uint64) {
	workruntimepkg.TickSmelt(workTaskExecWorldEnv{w: w}, a, wt, nowTick)
}

func (w *World) tickBuildBlueprint(a *Agent, wt *tasks.WorkTask, nowTick uint64) {
	res := workruntimepkg.TickBuildBlueprint(workTaskExecWorldEnv{w: w}, a, wt, nowTick, w.cfg.BlueprintBlocksPerTick)
	if !res.Completed {
		return
	}
	if w.stats != nil {
...
func handleTaskClaimLand(w *World, a *Agent, tr protocol.TaskReq, nowTick uint64) {
	claimspkg.HandleTaskClaimLand(claimTaskWorldEnv{w: w}, actionResult, a, tr, nowTick, w.cfg.AllowClaims)
}

func handleTaskBuildBlueprint(w *World, a *Agent, tr protocol.TaskReq, nowTick uint64) {
	workruntimepkg.HandleTaskBuildBlueprint(workTaskReqWorldEnv{w: w}, actionResult, a, tr, nowTick, w.cfg.AllowBuild)
}
