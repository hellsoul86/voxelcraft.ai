...
import miningpkg "voxelcraft.ai/internal/sim/world/feature/work/mining"
...
func MineProgress(workTicks int, blockName string, inventory map[string]int) float64 {
	...
	tier := miningpkg.BestToolTier(inventory, family)
	workNeeded, _ := miningpkg.MineParamsForTier(tier)
